...
def upgrade() -> None:
    ...
    sa.Column('environment', sa.Enum('PRODUCTION', 'STAGING', 'PREVIEW', name='deployment_environment'), nullable=False),
    sa.Column('status', sa.Enum('SUCCESS', 'FAILED', 'IN_PROGRESS', name='deployment_status'), nullable=False),
    ...
    sa.Column('severity', sa.Enum('CRITICAL', 'HIGH', 'MEDIUM', 'LOW', 'INFO', name='pr_severity'), nullable=False),
    sa.Column('category', sa.Enum('SECURITY', 'PERFORMANCE', 'BUG', 'STYLE', 'BEST_PRACTICES', 'TESTING', 'OTHERS', name='pr_category'), nullable=False),
    ...
    op.create_index(op.f('ix_review_issues_review_id'), 'review_issues', ['review_id'], unique=False)
